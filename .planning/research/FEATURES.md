...
| Credibility / social proof: bio with real career highlights, org affiliations, client/engagement logos | Trust is the gate to any inquiry; disability lived-experience is the differentiated authority | LOW | Conv | NYLPI, Manhattan BP training, JED Foundation, etc. |
